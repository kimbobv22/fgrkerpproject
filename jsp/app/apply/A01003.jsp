...
<%if(isAdmin_){%>
		$(document).on("pagebeforecreate",function(){
			var rejectDataView_ = $("[jg-dataset='a01003ApplyRejectData']");
		...
		function atFuncA01003_reject(){
			...
			rejectDataView_.JGValidator("validate",function(result_){
				...
				JGService.ajax(RKCommon.apply.requestURLKey,{
					data : {
						srvID : "rejectMemberApply"
						,rejectData : rejectData_.toJSONString(true)
					},success : function(data_){
						$.unblockUI();
						$("#a01003RejectPopup").popup("close");
...
<%if(isAdmin_){ %>
						<tr>
							<td colspan="2" style="##fx:##status## !== '00003' ? 'display:none;' : ''">
								<a href="#a01003RejectPopup" data-rel="popup" class="ui-btn ui-btn-d rk-responsive-r">반려</a>
							</td>
						</tr>
<%}%>
					</tbody>
			...
			<div data-role="tabs" class="apply-tabs">
				<div data-role="navbar">
					<ul>
						<li><a href="#a01003BasicView" data-ajax="false">기본정보</a></li>
...
<%if(isAdmin_){%>
			<div data-role="popup" id="a01003RejectPopup" class="reject-popup rk-responsive-size" data-position-to="window">
				<div class="ui-content">
					<h3>반려사유</h3>
					<div class="rk-content-view">
						<table class="rk-content-data-view" jg-dataset="a01003ApplyRejectData">
							<tbody>
								<tr>
						...
						<div class="btn-handle">
							<a href="javascript:atFuncA01003_reject();" class="ui-btn ui-btn-c rk-responsive-r">반려</a>
