...
<div data-role="page">
	...
	<div data-role="content">
		<div id="a03005" class="a03005 rk-responsive-p" rk-mis-id="<%=misId_%>" rk-mis-title="<%=misTitle_%>">
			<h3>팀장지원 현황</h3>
			<div class="top-search-nav" jg-dataset="a03005CondData">
				<div>
			...
			<div class="apply-list" jg-dataset="a03005ApplyData">
				<div class="apply-list-row rk-color-white-back-cursor rk-color-gray2-border-b-last-child rk-color-gray2-border-t">
					<a href="##fx:'javascript:atFuncA03005_goApply(##dataset.rowIndex##);'" class="apply-list-row-item">
