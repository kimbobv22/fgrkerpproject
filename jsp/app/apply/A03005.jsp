...
<div data-role="page">
	...
	<div data-role="content">
		<div id="a03005" class="a03005" rk-mis-id="<%=misId_%>" rk-mis-title="<%=misTitle_%>">
			<div class="rk-responsive-p">
			<h3>팀장지원 현황</h3>
			</div>
			<div class="top-search-nav rk-responsive-p" jg-dataset="a03005CondData">
				<div>
					<div class="ui-grid-a ministry-select-grid">
						<div class="ui-block-a"><a href="javascript:atFuncA03005_selectMinistry();" class="ui-btn">##fx:(isBlank(##mis_id##) ? '사역을 선택하세요' : ##mis_title##)</a></div>
						<div class="ui-block-b"><a href="javascript:atFuncA03005_emptyMinistry();" class="##fx:'ui-btn '+(isBlank(##mis_id##) ? 'ui-disabled' : '')">비우기</a></div>
					</div>
					<div class="ui-grid-c total-search-bar">
						...
						<div class="ui-block-c"><input type="text" placeholder="지원자명,연락처로 검색" data-wrapper-class="search-bar" jg-column="searchText" rk-onenter="atFuncA03005_search();"></div>
						<div class="ui-block-d"><a href="javascript:atFuncA03005_search();" class="ui-btn">검색</a></div>
					</div>
					<div class="ui-grid-b ui-responsive belong-bar">
						<div class="ui-block-a">
							<select jg-column="belong_ctg1" jg-bind-dataset="a03005BelongCtg1" jg-display-column="BELONG_NM" jg-value-column="BELONG_ID"></select>
						</div>
						<div class="ui-block-b">
							<select jg-column="belong_ctg2" jg-bind-dataset="a03005BelongCtg2" jg-display-column="BELONG_NM" jg-value-column="BELONG_ID"></select>
						</div>
						<div class="ui-block-c">
							<select jg-column="belong_ctg3" jg-bind-dataset="a03005BelongCtg3" jg-display-column="BELONG_NM" jg-value-column="BELONG_ID"></select>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ui-content" jg-dataset="a03005ApplyData">
				<div class="apply-list ui-grid-e rk-color-white-back-cursor rk-color-gray2-border-b-last-child rk-color-gray2-border-t">
					...
					<div class="ui-block-d">
						<a href="javascript:void(0);" onclick="##fx:'atFuncA03005_switchFee(this, ##dataset.rowIndex##);'" class="##fx:'ui-btn ui-mini' + (##fee_yn## === 'Y' ? ' ui-btn-c' : '');">
							##fx:##fee_yn## === "Y" ? "사역비O" : "사역비X"
						</a>
					</div>
					<div class="ui-block-e">
						<a href="javascript:void(0);" onclick="##fx:'atFuncA03005_switchReport(this, ##dataset.rowIndex##);'" class="##fx:'ui-btn ui-mini' + (##bookreport_yn## === 'Y' ? ' ui-btn-b' : '');">
							##fx:##bookreport_yn## === "Y" ? "독서O" : "독서X"
						</a>
					</div>
					<div class="ui-block-f">
						<a href="##fx:'javascript:atFuncA03005_goApply(##dataset.rowIndex##);'" class="ui-btn ui-mini">지원서확인</a>
					</div>
				</div>
			</div>
		</div>
