...
public class A09005 extends JGAction{
	
	protected final String _querysetKeyName = "app.apply.A09005";
	
	public void getLeaderAndMemberList(JGServiceBox serviceBox_) throws Exception{
		JGDataset condData_ = serviceBox_.getParameterAsDataset("condData");
		JGDBQuery query_ = JGDBXMLQueryManager.sharedManager().createQuery(_querysetKeyName, "getLeaderAndMemberList"
				,condData_);
