...
public class A03005 extends JGAction{
	
	protected final String _querysetKeyName = "app.apply.A03005";
	...
	public void getLeaderApplyList(JGServiceBox serviceBox_) throws Exception{
		JGDataset condData_ = serviceBox_.getParameterAsDataset("condData");
		
		JGDBQuery query_ = JGDBXMLQueryManager.sharedManager().createQuery(_querysetKeyName, "getLeaderApplyList", condData_);
